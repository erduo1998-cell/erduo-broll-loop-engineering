...
- manifest schema 4 必须通过新父 Skill、十个阶段 Skill、八个官方 Skill、两个宿主根、当前发行源和受控备份目录的严格路径校验；schema 1/2/3 只按各自历史闭集迁移，旧父 Skill 名称仅在所有权匹配时退休，重复目标、越界记录或被用户替换的旧目标都会使升级和卸载停止。
