...
- 新增 runtime plan/frozen block schema、Planner/validator、实际媒体 hash/FFprobe/完整解码 validator，以及 `broll-runtime-plan`、`broll-hybrid-integrate`、`broll-hybrid-render` 三个隔离阶段。
